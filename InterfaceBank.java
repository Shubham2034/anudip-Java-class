...
class CurrentAccount1 implements Account {
    ...
    public void CurrentAccount(double initialDeposit, double overdraftLimit) {
        this.balance = initialDeposit;
...
Bank bank = new Bank();
        ...
        SavingsAccount1 savingsAccount = new SavingsAccount1(0, 0);
        System.out.println("Savings Account:\nInitial Deposit: $1000.00\nInterest rate: 1.25%");
        
        // Create a CurrentAccount with an initial deposit and overdraft limit
        CurrentAccount1 currentAccount = new CurrentAccount1();
